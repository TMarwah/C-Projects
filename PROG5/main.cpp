...
int main() {
   ...
   if (test == 6) {
      cout << endl;
      cout << "clearTest constructor called" << endl;
      IntList clearTest;
      cout << "pushback 10" << endl;
      clearTest.push_back(10);
      cout << "pushback 20" << endl;
      clearTest.push_back(20);
      cout << "pushback 30" << endl;
      clearTest.push_back(30);
      cout << "clearTest pre-clear: " << clearTest << endl;
      cout << "clearing list" << endl;
      clearTest.clear();
      cout << "clearTest post-clear: " << clearTest << endl;
   }
   /*
